...
source "proxmox-iso" "proxmox-ve" {
  ...
  vm_name              = "pve-8.4"
  template_name        = "pve-8.4"
  template_description = "Proxmox VE 8.4 (Nested)"
  boot_iso {
    type             = "scsi"
  ...
  boot_command = [
    ...
    "<wait5>rm -f /etc/apt/sources.list.d/pve-enterprise.list<enter>",
    "<wait5>rm -f /etc/apt/sources.list.d/ceph.list<enter>",
