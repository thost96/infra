...
source "proxmox-iso" "ubuntu-server-resolute-docker" {
    ...
    template_description = "Ubuntu 26.04 Resolute Raccoon with Docker"
...
build {
    ...
    name = "ubuntu-server-resolute-docker"
    sources = [
      "proxmox-iso.ubuntu-server-resolute-docker"
    ]
