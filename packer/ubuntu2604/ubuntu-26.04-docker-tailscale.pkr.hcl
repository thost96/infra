...
source "proxmox-iso" "ubuntu-server-resolute-docker-tailscale" {
    ...
    vm_name = "ubuntu-server-resolute-docker-tailscale"
    template_description = "Ubuntu 26.04 Resolute Raccoon with Docker and Tailscale"
    ...
    template_name        = "2604-docker-tailscale"
...
build {
    ...
    name = "ubuntu-server-resolute-docker-tailscale"
    sources = [
      "proxmox-iso.ubuntu-server-resolute-docker-tailscale"
    ]
